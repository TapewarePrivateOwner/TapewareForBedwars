...
local array = loadstring(game:HttpGet("https://raw.githubusercontent.com/TapewarePrivateOwner/TapewareForBedwars/main/ArrayList"))()
local commands = loadstring(game:HttpGet("https://raw.githubusercontent.com/TapewarePrivateOwner/TapewareForBedwars/main/Commands", true))()
local lib = {
    ["Rainbow"] = false,
    ["Notifications"] = false,
    ["Sounds"] = true,
