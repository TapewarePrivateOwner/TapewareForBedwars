...
ui.Enabled = shared["TapewareConfigs"].Enabled
...
spawn(function()
    repeat
        task.wait()
        mark.TextColor3 = Color3.fromHSV(tick()%5/5,1,1)
        mark.TextStrokeTransparency = shared["TapewareConfigs"].StrokeTransparency
        mark.Visible = shared["TapewareConfigs"].Watermark
